...
export function extractSections(text: string, sectionType: string): string {
  ...
  const sectionPatterns = {
    general_atmosphere: [
      /(?:^|\n)(?:общая атмосфера|general atmosphere)[^:]*:(?:\n|.)*?(?=\n\n|\n(?:[А-Я]|[A-Z])|$)/i,
  ...
  const fallbackResponses = {
    ...
    love_relationships: 'Рекомендации по отношениям и любви: В личной жизни сегодня наступает период гармонии и взаимопонимания с близкими людьми. Открытое и честное общение поможет укрепить существующие отношения и разрешить любые недопонимания. Если вы одиноки, то велика вероятность интересного знакомства, которое может перерасти в нечто большее. Проявите внимание и заботу к партнеру, даже небольшой знак внимания будет высоко оценен. Избегайте чрезмерного контроля и давления, позвольте отношениям развиваться естественно.',
    health_wellbeing: 'Состояние здоровья и эмоционального баланса: Сегодня стоит уделить особое внимание своему физическому и эмоциональному здоровью. Небольшая прогулка на свежем воздухе или легкая физическая активность поможет восстановить энергетический баланс. Избегайте стрессовых ситуаций и конфликтов, они могут негативно сказаться на вашем самочувствии. Хорошее время для начала новой программы оздоровления или изменения режима питания. Вечером уделите время медитации или другим практикам расслабления, это поможет снять накопившееся напряжение.',
    daily_advice: 'Практичный совет дня: Разбейте большие цели на маленькие, выполнимые задачи и отмечайте каждое достижение. Это поможет поддерживать мотивацию и видеть свой прогресс. Не бойтесь просить помощи, когда она вам действительно нужна - это признак силы, а не слабости. Развивайте гибкость мышления и готовность адаптироваться к меняющимся обстоятельствам. Помните, что иногда лучший выход - это сделать перерыв и вернуться к проблеме со свежим взглядом. Практикуйте благодарность за то, что уже есть в вашей жизни, это привлечет еще больше позитивных изменений.'
  };
