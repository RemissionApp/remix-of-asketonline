    ...
    if (detailed) {
      ...
      const horoscopeData = {
        ...
        sections: {
          ...
          love_relationships: extractSection(
            horoscopeText,
            'любовь',
            'отношения',
            'love',
          ...
          health_wellbeing: extractSection(
            horoscopeText,
            'здоровье',
            'самочувствие',
            'health',
...
function getUserPrompt(
  ...
  const signPrompts = {
    ru: `Создай ${detailed ? 'подробный' : 'краткий'} гороскоп для знака ${sign} на сегодня.`,
