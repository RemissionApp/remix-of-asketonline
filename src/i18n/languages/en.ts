...
export const enTranslations: Translations = {
  ...
  legal: {
    ...
    introText:
      'The ASKET application respects your privacy and is committed to protecting your personal data. This privacy policy explains how we collect, use, disclose, process and protect the information you provide when using our application.',
    ...
    usageData:
      'Usage data: information about your pacts, days of observance, and interaction with the application',
    ...
    dataSecurityText:
      'We use commercially acceptable measures to protect your data, but remember that no method of transmission over the internet is 100% secure.',
    policyChanges: 'Changes to Policy',
    policyChangesText:
      'We may update our privacy policy from time to time. We will notify you of any changes by posting the new privacy policy on this page.',
    contact: 'Contact',
    contactText:
      'If you have any questions about this privacy policy, please contact us at: support@asket-app.com',
    acceptance: 'Acceptance of Terms',
    acceptanceText:
      'By using the ASKET application, you agree to comply with these Terms of Use. If you do not agree with these terms, please do not use our application.',
    serviceDescription: 'Service Description',
    serviceDescriptionText:
      'The ASKET application provides a platform for creating and tracking personal ascesis pacts, receiving spiritual advice, and tracking personal progress. We reserve the right to modify, suspend, or discontinue any aspect of the service at any time.',
    userAccounts: 'User Accounts',
    userAccountsText:
      'To use some features of the application, you need to create an account. You are responsible for maintaining the confidentiality of your credentials and for all activities that occur under your account.',
    userContent: 'User Content',
    userContentText:
      'You retain all rights to content you create in the application. However, by creating content, you grant us a non-exclusive license to use, reproduce, and display that content in connection with the operation of the application.',
    prohibitedBehavior: 'Prohibited Behavior',
    prohibitedBehaviorText:
      'You are prohibited from using the application for illegal purposes or violating the rights of others. Content that is:',
    ...
    disclaimersText:
      "The application is provided 'as is' and 'as available'. We make no warranties regarding the accuracy, completeness, or reliability of content or services provided through the application.",
    termsChanges: 'Changes to Terms',
    termsChangesText:
      'We may modify these terms at any time. By continuing to use the application after such changes, you agree to the updated terms.',
    termination: 'Termination',
    terminationText:
      'We may terminate or suspend your access to the application immediately, without prior notice or liability, for any reason, including violation of these terms.',
  },
