...
export const enTranslations: Translations = {
  ...
  numerology: {
    ...
    ,
    v2: {
      systems: { pythagorean: 'Pythagorean', chaldean: 'Chaldean' },
      switchSystem: 'System',
      ...
      numbers: {
        ...
        chaldeanLife: 'Chaldean Life Number',
        chaldeanName: 'Chaldean Name Number',
      },
      sections: {
        essence: 'Essence',
        gifts: 'Gifts',
      ...
      square: {
        title: 'Pythagorean Square',
        intro: 'Distribution of energies across 9 cells — your character map.',
        cells: {
          1: 'Character', 2: 'Energy', 3: 'Interest',
          4: 'Health', 5: 'Logic', 6: 'Work',
          7: 'Luck', 8: 'Duty', 9: 'Memory',
        },
        levels: {
          absent: 'Absent',
          weak: 'Weak',
        ...
        working: { A: 'Goal', B: 'Family', C: 'Habit', D: 'Past' },
      ...
      karma: {
        ...
        sky: 'Sky (Spirit)',
        earth: 'Earth (Body)',
        missions: { social: 'Social', spiritual: 'Spiritual', ancestral: 'Ancestral' },
        planets: {
      ...
      deepAnalysis: {
        title: 'Deep analysis',
        generate: 'Get master reading',
        loading: 'Master is contemplating...',
        error: 'Unable to fetch reading. Try later.',
        retry: 'Retry now',
        retryIn: 'Retry in {n}s…',
        rateLimited: 'Too many requests. Hold on a moment.',
        creditsExhausted: 'AI credits exhausted. Top up in settings.',
        save: 'Save to Book of Answers',
        saved: 'Saved',
      },
      answersBook: {
      ...
      enterName: 'Add your full name in profile for Chaldean analysis',
    },
  },
  common: {
    cancel: 'Cancel',
