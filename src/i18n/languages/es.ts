...
export const esTranslations: Translations = {
  ...
  universe: {
    ...
    learnMore: 'Saber más',
    chatTitle: 'Diálogo con Lyra',
    chatDescription: 'Haz una pregunta al Universo',
    enterChat: 'Entrar al chat',
    chatProTitle: 'Diálogo con Lyra',
    chatProMessage: 'Desbloquea PRO para hablar con Lyra',
  ...
  numerology: {
    ...
    ,
    v2: {
      systems: { pythagorean: 'Pitagórico', chaldean: 'Caldeo' },
      switchSystem: 'Sistema',
      coreNumbers: 'Números clave',
      numbers: {
        lifePath: 'Camino de Vida',
        expression: 'Número de Expresión',
        soul: 'Número del Alma',
        personality: 'Número de Personalidad',
        maturity: 'Número de Madurez',
        balance: 'Número de Equilibrio',
        personalYear: 'Año Personal',
        chaldeanLife: 'Número de Vida Caldeo',
        chaldeanName: 'Número del Nombre Caldeo',
      },
      sections: {
        essence: 'Esencia',
        gifts: 'Dones',
        ...
        zodiac: 'Zodíaco',
        element: 'Elemento',
        arcana: 'Arcano del Tarot',
        colors: 'Colores de poder',
        crystals: 'Cristales',
        luckyDay: 'Día de la suerte',
        luckyNumbers: 'Números de la suerte',
      },
      square: {
        title: 'Cuadrado de Pitágoras',
        intro: 'Distribución de energías en 9 celdas — tu mapa de carácter.',
        cells: {
          1: 'Carácter', 2: 'Energía', 3: 'Interés',
          4: 'Salud', 5: 'Lógica', 6: 'Trabajo',
          7: 'Suerte', 8: 'Deber', 9: 'Memoria',
        },
        levels: {
          absent: 'Ausente',
          weak: 'Débil',
        ...
        working: { A: 'Meta', B: 'Familia', C: 'Hábito', D: 'Pasado' },
        analysis: 'Análisis de celdas',
      },
      karma: {
        title: 'Matriz Kármica',
        center: 'Centro (Yo)',
        sky: 'Cielo (Espíritu)',
        earth: 'Tierra (Cuerpo)',
        missions: { social: 'Social', spiritual: 'Espiritual', ancestral: 'Ancestral' },
        planets: {
      ...
      deepAnalysis: {
        ...
        generate: 'Obtener lectura del maestro',
        loading: 'El maestro está contemplando...',
        error: 'No se pudo obtener la lectura. Inténtalo más tarde.',
        retry: 'Reintentar ahora',
        retryIn: 'Reintento en {n}s…',
        rateLimited: 'Demasiadas solicitudes. Espera un momento.',
        creditsExhausted: 'Créditos AI agotados. Recarga en ajustes.',
        save: 'Guardar en el Libro de Respuestas',
        saved: 'Guardado',
      },
      answersBook: {
        title: 'Libro de Respuestas',
        empty: 'Aún no hay lecturas guardadas.',
        delete: 'Eliminar',
        savedAt: 'Guardado',
      },
      enterName: 'Añade tu nombre completo en el perfil para análisis caldeo',
    },
  },
  common: {
    cancel: 'Cancelar',
  ...
  lyra: {
    voiceGuide: 'Lyra',
    callButton: 'Llamar a Lyra',
    callScreen: 'Llamada de Lyra',
    callHistory: 'Conversaciones con Lyra',
    callSubtitle: 'Tu guía cósmica, siempre presente',
    callSubtitleShort: 'Conéctate con la sabiduría cósmica',
    callTitle: 'Llamada de Lyra',
    callButtonShort: 'Llamar a Lyra',
    online: 'en línea',
    callTip: 'Presiona el botón de llamada para conectarte con Lyra y la sabiduría cósmica del Universo',
    ...
    errorMicDenied: 'Permite el acceso al micrófono para hablar con Lyra.',
    errorAgentUnavailable: 'Lyra no está disponible ahora. Inténtalo en un momento.',
