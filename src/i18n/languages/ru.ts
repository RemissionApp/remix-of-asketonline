...
export const ruTranslations: Translations = {
  ...
  lyra: {
    voiceGuide: 'Лира',
    callButton: 'Позвонить Лире',
    callScreen: 'Звонок Лиры',
    callHistory: 'Разговоры с Лирой',
    callSubtitle: 'Лира всегда рядом и готова слушать',
    callSubtitleShort: 'Соединитесь с космической мудростью',
    callTitle: 'Звонок Лиры',
    callButtonShort: 'Позвонить Лире',
    online: 'онлайн',
    callTip: 'Нажмите на кнопку звонка, чтобы соединиться с Лирой и космической мудростью Вселенной',
    ...
    hearFromGuide: 'Услышать от Лиры',
    errorMicDenied: 'Разрешите доступ к микрофону, чтобы говорить с Лирой.',
    errorAgentUnavailable: 'Голос Лиры временно недоступен. Попробуйте чуть позже.',
