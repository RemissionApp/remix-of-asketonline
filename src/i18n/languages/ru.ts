...
export const ruTranslations: Translations = {
  ...
  legal: {
    ...
    introText: "Приложение ASKET уважает вашу конфиденциальность и стремится защитить ваши персональные данные. Эта политика конфиденциальности объясняет, как мы собираем, используем, раскрываем, обрабатываем и защищаем информацию, которую вы предоставляете при использовании нашего приложения.",
    ...
    usageData: "Данные об использовании: информация о ваших пактах, днях соблюдения и взаимодействии с приложением",
    ...
    dataSecurityText: "Мы используем коммерчески приемлемые меры для защиты ваших данных, но помните, что ни один метод передачи через интернет не является 100% безопасным.",
    policyChanges: "Изменения в политике",
    policyChangesText: "Мы можем обновлять нашу политику конфиденциальности время от времени. Мы уведомим вас о любых изменениях, разместив новую политику конфиденциальности на этой странице.",
    contact: "Контакты",
    contactText: "Если у вас есть вопросы по поводу этой политики конфиденциальности, пожалуйста, свяжитесь с нами по адресу: support@asket-app.com",
    ...
    serviceDescriptionText: "Приложение ASKET предоставляет платформу для создания и отслеживания личных пактов аскезы, получения духовных советов и отслеживания личного прогресса. Мы оставляем за собой право изменять, приостанавливать или прекращать любой аспект ус��уги в любое время.",
