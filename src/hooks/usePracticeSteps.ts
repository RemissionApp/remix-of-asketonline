  ...
  const steps = [
    {
      ...
      visualGuide:
        "Look around your current environment and confirm you're in a space where you can fully focus without distractions.",
    },
    {
      ...
      visualGuide:
        'Close your eyes or find a soft focus point at eye level about 3-6 feet in front of you. This helps center your attention.',
    },
    {
      ...
      visualGuide:
        'Look at yourself in a mirror if available, or visualize yourself succeeding as you speak. Make eye contact with your reflection to strengthen your connection to the words.',
    },
    {
      ...
      visualGuide:
        'With eyes closed, look slightly upward toward the space between your eyebrows (your third eye center), which helps activate visualization centers in the brain.',
    },
    {
      ...
      visualGuide:
        'With eyes still closed, bring your awareness to the center of your chest (heart center) as you visualize, connecting the affirmation to your emotional center.',
    },
  ];
