...
export function generateFallbackHoroscope(sign: string, language: string, translations: any): DetailedHoroscope {
  ...
  const defaultMessages = {
    ru: {
      ...
      health: 'Уделите внимание своему физическому и эмоциональному здоровью. Небольшая прогулка на свежем воздухе поможет восстановить силы. Сегодня хороший день для начала новой программы упражнений или изменения режима питания. Обратите внимание на качество сна, это важно для вашего самочувствия. Постарайтесь избегать стрессовых ситуаций в течение дня.',
    ...
    en: {
      general: 'Today will be filled with opportunities for personal growth and self-knowledge. Planetary influences contribute to clarity of thinking and making balanced decisions. External circumstances will work in your favor, especially in the first half of the day. In the evening, you may experience a slight emotional decline, which can be easily overcome with a favorite hobby. Try to be open to new experiences.',
