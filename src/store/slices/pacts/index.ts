...
import { createMarkDayCompleteSlice, MarkDayCompleteSlice } from './markDayComplete';
...
import { createSyncPactsSlice, SyncPactsSlice } from './syncPactsWithCurrentDate';

// Combined types for PactsSlice
export interface PactsSlice extends 
  PactsState,
  AddPactSlice, 
