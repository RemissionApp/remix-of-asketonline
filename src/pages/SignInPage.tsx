          ...
          <CardContent className="pt-6">
            <div className="text-center mb-6">
              ...
              <p className="text-cosmic-secondary mt-2">
                {t.auth?.signInSubtitle || "Войдите, чтобы продолжить"}
              </p>
            </div>
                ...
                <div className="pt-2">
                  <CosmicButton type="submit" className="w-full" disabled={loading}>
                    {loading ? (
                      ...
                      <span>{t.auth?.signInButton || "Войти"}</span>
                    )}
                  </CosmicButton>
                </div>
                
                <div className="text-center text-cosmic-secondary text-sm pt-2">
                  <p>{t.auth?.noAccount || "Нет аккаунта?"} {' '}
                    <Link to="/signup" className="text-cosmic-accent hover:underline">
