        ...
        <div className="w-full cosmic-card p-6 backdrop-blur-sm bg-cosmic-dark/40 border border-cosmic-accent/30 rounded-lg">
          <div className="space-y-6">
            <p className="text-cosmic-light">
              {t.support?.contactInfo || "Для связи с нашей службой поддержки, вы можете воспользоваться следующими способами:"}
            </p>
            ...
            <div className="space-y-4 pt-2">
              ...
              <p className="text-cosmic-secondary text-sm">
                {t.support?.responseTime || "Мы обычно отвечаем в течение 24 часов в рабочие дни."}
              </p>
            </div>
          </div>
        </div>
