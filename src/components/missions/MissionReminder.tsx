...
export const MissionReminder: React.FC = () => {
  ...
  const getReminderText = () => {
    switch(language) {
      case 'ru': return 'У вас есть невыполненная задача в миссии';
      case 'es': return 'Tienes una tarea pendiente en tu misión';
      default: return 'You have a pending mission task';
    }
  };
