    ...
    <div className="flex items-start mb-4">
      ...
      <div className="bg-cosmic-dark/80 border border-cosmic-accent/20 text-cosmic-secondary rounded-2xl rounded-tl-none p-4 max-w-xs md:max-w-md backdrop-blur-md relative">
        ...
        <div className="flex items-center space-x-2 relative z-10">
          ...
          <span className="w-2 h-2 bg-cosmic-accent rounded-full animate-bounce" style={{ animationDelay: '0.2s' }}></span>
          <span className="w-2 h-2 bg-cosmic-accent rounded-full animate-bounce" style={{ animationDelay: '0.4s' }}></span>
        </div>
      </div>
    </div>
  );
