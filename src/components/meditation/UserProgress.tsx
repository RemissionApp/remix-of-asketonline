    ...
    <div className="p-6 space-y-6">
      ...
      <div className="bg-gradient-to-r from-cosmic-accent/20 to-cosmic-gold/20 backdrop-blur-sm border border-cosmic-accent/30 rounded-lg p-4">
        <div className="flex items-center gap-3 mb-2">
          ...
          <div>
            ...
            <p className="text-cosmic-secondary text-sm">
              Пройдено {consecutiveDays} дней подряд
            </p>
          </div>
        </div>
        ...
        <p className="text-sm text-cosmic-accent">
          Разблокирован уровень: {unlockedLevel}
        </p>
      </div>
        ...
        <div className="grid grid-cols-7 gap-2">
          {['ПН', 'ВТ', 'СР', 'ЧТ', 'ПТ', 'СБ', 'ВС'].map((day, index) => (
            <div key={day} className="text-center">
              ...
              <div className="w-full h-12 bg-cosmic-dark/40 rounded border border-cosmic-accent/20 flex items-end justify-center">
                <div
