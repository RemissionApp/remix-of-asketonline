      ...
      toast({
        ...
        description:
          language === 'ru'
            ...
            : language === 'es'
              ? 'No se pudo alternar el micrófono'
  ...
  const toggleSpeaker = async () => {
    ...
    try {
      ...
      toast({
        ...
        description:
          language === 'ru'
            ? 'Не удалось переключить динамик'
            : language === 'es'
              ? 'No se pudo alternar el altavoz'
      ...
      <div className="w-full max-w-sm mx-auto px-4">
        <div className="bg-transparent p-4 text-center space-y-6">
          ...
          <div className="text-center">
            ...
            <p className="text-cosmic-secondary text-sm">{getSubtitle()}</p>
          </div>
