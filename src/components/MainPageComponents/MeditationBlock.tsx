...
export const MeditationBlock: React.FC = () => {
  ...
  const getMeditationPhrase = () => {
    switch (language) {
      case 'ru':
        return 'Переходим к медитациям. Найдите гармонию и покой через практики осознанности.';
      case 'es':
        return 'Vamos a las meditaciones. Encuentra armonía y paz a través de prácticas de atención plena.';
      default:
        return 'Let us go to meditations. Find harmony and peace through mindfulness practices.';
    }
  };
      ...
      <div className="w-full p-3 sm:p-4 rounded-lg backdrop-blur-sm bg-transparent relative z-10">
        ...
        <p className="text-white mb-3 sm:mb-4 text-sm sm:text-base text-shadow text-center">
          {language === 'ru'
            ...
            : language === 'es'
              ? 'Descubre una colección de meditaciones que te ayudarán en tu camino.'
