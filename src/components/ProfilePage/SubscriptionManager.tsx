        ...
        <div className="space-y-4">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-sm text-cosmic-secondary font-sans">Активная подписка</p>
            </div>
            <ProBadge />
          </div>
          ...
          <div className="pt-3 border-t border-cosmic-accent/20">
            <div className="flex items-center justify-between">
              <div className="flex flex-col">
                <span className="text-cosmic-secondary text-sm font-sans">Режим разработчика</span>
                <span className="text-cosmic-secondary text-xs font-sans">Быстрое переключение</span>
              </div>
              <div className="flex items-center gap-2">
                <Label htmlFor="pro-mode" className="text-cosmic-gold font-sans text-sm">
                  PRO
                </Label>
                <Switch
                  id="pro-mode"
        ...
        <div className="space-y-4">
          ...
          <div className="pt-3 border-t border-cosmic-accent/20">
            <div className="flex items-center justify-between">
              ...
              <div className="flex items-center gap-2">
                <Label htmlFor="pro-mode" className="text-cosmic-secondary font-sans text-sm">
                  Бесплатно
                </Label>
                <Switch
                  id="pro-mode"
